 ...
 * Return: size of list
 */
list_t *add_node(list_t **head, const char *str1, int num1)
{
	list_t *new_head;
 ...
 * Return: size of list
 */
list_t *add_node_end(list_t **head, const char *str1, int num1)
{
...
/**
 * delete_node_at_index - The deletes node at given index.
